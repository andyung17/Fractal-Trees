...
A Fractal Tree utilizes recursion (pattern) to make up the branches that are apart of the tree. These branches can continue to grow infinitely and have no restriction.
